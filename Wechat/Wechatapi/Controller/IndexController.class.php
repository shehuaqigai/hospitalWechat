...
class IndexController extends Controller {
    ...
    public function customCreateMenu(){
        $data=array("button"=>array(
                            array("name"=>"医院概况","sub_button"=>array(
                                array("type"=>"click","name"=>"医院介绍","key"=>"hospitalInfo"),
                                array("type"=>"click","name"=>"科室介绍","key"=>"departmentInfo"),
                                array("type"=>"click","name"=>"专家介绍","key"=>"expertInfo"),
                                array("type"=>"click","name"=>"交通路线","key"=>"trafficRoute"),

                                                                   )
                                 ),
                            array("name"=>"在线服务","sub_button"=>array(
                                array("type"=>"view","name"=>"化验单查询","url"=>"http://cn.bing.com"),
                                array("type"=>"click","name"=>"就诊须知","key"=>"http://cn.bing.com"),
                                array("type"=>"view","name"=>"出诊信息","url"=>"http://cn.bing.com"),
                                array("type"=>"click","name"=>"微网站","key"=>"http://cn.bing.com"),
                                                                  )
                                   ),
                            array("name"=>"健康资讯","sub_button"=>array(
                                array("type"=>"click","name"=>"健康讲堂","key"=>"query"),
                                array("type"=>"click","name"=>"公告通知","key"=>"customer"),
                                array("type"=>"click","name"=>"科普知识","key"=>"messageBack"),
                                                                  )
                                )
        ));
    ...
    */
    ...
    private function eventPullSubscribe(){
        ...
        self::$wechat->responsiveText('你好，欢迎关注北京大学第六医院服务号,专注疾病防治,关注百姓健康。');
        //如果是扫描带参数二维会有这个字段
        if(!empty($eventKey)){
